    ...
    UserComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._userService.post(global_1.Global.UserAdd, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._userService.put(global_1.Global.UserEdit, formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._userService.delete(global_1.Global.UserDelete, formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
